...
public class PathFinder {
	 ...
	 */
	public PathFinder(TiledMap map, int maxSearchDistance, boolean allowDiagMovement) {
	...
	public PathFinder(TiledMap map, int maxSearchDistance, boolean allowDiagMovement,
		...
		nodes = new Node[map.getProperties().get("width", Integer.class)][map.getProperties().get(
...
// next possible
	...
	protected boolean isValidLocation(int sx, int sy, int x, int y) {
		boolean invalid = (x < 0) || (y < 0)
				|| (x >= map.getProperties().get("width", Integer.class))
				|| (y >= map.getProperties().get("height", Integer.class));
